	...
	float *x, float *y, float *z)
{
	...
	*x = cie_colour_match[(int)(wavelength - 380) / 5][0];
	*y = cie_colour_match[(int)(wavelength - 380) / 5][1];
	*z = cie_colour_match[(int)(wavelength - 380) / 5][2];
...
void cs_init(colorSystem* cs)
{
	...
	cs->xBlue = 0.1669;
	cs->yBlue = 0.0085;
	cs->xWhite = 0.33333333;
	cs->yWhite = 0.33333333;
	cs->gamma = 0.0f;
}